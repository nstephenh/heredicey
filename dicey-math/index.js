...
class ParseResult {
    ...
    get result() {
        ...
        for (let target of [
            ...
            {name: "Marine", t: 4, save: 3},
            {name: "Terminator", t: 4, save: 2},
        ]) {
            ...
            this.parsed.body[output_counter++] = {
                ...
                "text": `Unsaved wounds on ${target.name} (T${target.t} ${target.save}+ SV) from ${num_shots} shots at BS ${bal_skill}, STR ${weapon_strength}, AP ${WEAPON_AP} ${with_breaching} weapon`,
            }
